 ...
 * 
 */
@WebServiceClient(name = "StudentsPortService", targetNamespace = "http://spring.io/guides/gs-producing-web-service", wsdlLocation = "http://localhost:8081/ws/students.wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSPORTSERVICE_QNAME = new QName("http://spring.io/guides/gs-producing-web-service", "StudentsPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/ws/students.wsdl");
    ...
    public StudentsPort getStudentsPortSoap11() {
        return super.getPort(new QName("http://spring.io/guides/gs-producing-web-service", "StudentsPortSoap11"), StudentsPort.class);
    }
    ...
    public StudentsPort getStudentsPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://spring.io/guides/gs-producing-web-service", "StudentsPortSoap11"), StudentsPort.class, features);
    }
